...
#' Definition of indicator Urban population is the midyear population of areas defined as urban in each
...
#' 
#' @name gmUrbanPopulation-data
#' @aliases gmUrbanPopulation
#' @references
#' \url{http://www.gapminder.org}
#' \url{http://spreadsheets.google.com/pub?key=pyj6tScZqmEfH89V6UQhpZA&gid=1&output=csv}
#' @docType data
